        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Professional medical transport services available 24/7 for your emergency needs.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm4.995 16.979H7.005v-.996h9.99v.996zm0-3.998H7.005v-.996h9.99v.996zm-9.99-5.993h9.99v.996H7.005v-.996z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Emergency Transport</li>
              <li className="text-gray-400">Non-Emergency Transport</li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Ambulan Service. All rights reserved.
            </p>
